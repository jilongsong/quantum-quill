...
export default function Page() {
  return (
    <div>
      <section style={{ height: "calc(100vh - 100px)" }} className="h-screen py-10 mx-auto max-w-7xl px-12 sm:px-10 lg:px-24 grid grid-rows-3 grid-cols-4 gap-4 grid-flow-row auto-rows-50">
        ...
        <Card className="flex items-center justify-center row-span-1 col-span-1">
          <CardContent>
            <Signature></Signature>
          </CardContent>
        </Card>
